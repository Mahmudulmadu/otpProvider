...
namespace OtpProvider.Infrastructure.Migrations
{
    ...
    [Migration("20251020053224_initialdb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.ApplicationUserRoles", b =>
                {
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.OtpProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.OtpRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.OtpVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.ApplicationUserRoles", b =>
                {
                    b.HasOne("OtpProvider.Domain.Entities.ApplicationRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OtpProvider.Domain.Entities.ApplicationUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.OtpRequest", b =>
                {
                    b.HasOne("OtpProvider.Domain.Entities.OtpProvider", "OtpProvider")
                        .WithMany("OtpRequests")
                        .HasForeignKey("OtpProviderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("OtpProvider.Domain.Entities.ApplicationUser", "SendByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("OtpProvider.Domain.Entities.OtpVerification", b =>
                {
                    b.HasOne("OtpProvider.Domain.Entities.OtpRequest", "OtpRequest")
